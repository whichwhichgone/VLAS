...
class LibrispeechASR(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        archive_path = {"dev" : "/zhaowei/data/dev-clean.tar.gz", 
                        "test" : "/zhaowei/data/test-clean.tar.gz",
                        "train.100" : "/zhaowei/data/train-clean-100.tar.gz",
                        "train.360" : "/zhaowei/data/train-clean-360.tar.gz"}

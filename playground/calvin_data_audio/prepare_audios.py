...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Convert the calvin json data to support for speech instructions."
    )
    parser.add_argument(
        "--instructions",
        type=str,
        help="Path to the calvin dataset instructions.",
    ...
    parser.add_argument(
        ...
        default="/zhaowei/data/calvin_audio",
    )
    parser.add_argument(
        "--num-chunks",
        type=int,
    ...
    synthesize_calvin_speech(
        instructions, task_name, args.calvin_audio_dir, text2speech, xvectors
    )

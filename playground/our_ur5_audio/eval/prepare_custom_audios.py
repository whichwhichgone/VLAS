...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--eval_instructions",
        type=str,
        default="/zhaowei/workspace/LLaVA/playground/our_ur5_audio/eval/new_custom_validation.yaml",
    )
    parser.add_argument(
        "--eval_audios", type=str, default="/zhaowei/data/our_ur5_eval_audio_custom"
    )

...
def get_updated_training_data(data_raw, instructions, ur5_audio):
    ...
    for item in tqdm(data_raw):
        ...
        if instruct_parts[1] not in instruct2id:
            instruct_parts[1] = instruct_parts[1].capitalize()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="playground/our_ur5/berkeley_our_ur5_training.json",
    )
    parser.add_argument(
        "--ur5_audio_json",
        type=str,
    ...
    parser.add_argument(
        ...
        default="/storage/zhaowei/data/ur5_audio_our/berkeley_our_ur5",
    )
    parser.add_argument(
        "--instructions",
        type=str,
        help="ur5 instructions in the dataset.",
        default="playground/our_ur5_audio/berkeley_our_ur5.jsonl",
    )

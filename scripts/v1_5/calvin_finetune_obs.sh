...
deepspeed llava/train/calvin_train_obs.py \
    ...
    --version v1 \
    --data_path ./playground/calvin_data/task_ABC_D_training.json \
    --image_folder ./playground/calvin_data/task_ABC_D \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-calvin-rel-obs-reduce5-v1-abc2d \
    --num_train_epochs 1 \
    ...
    --report_to_wandb_run_name vlas_ft_stage3_without_audio_abc2d

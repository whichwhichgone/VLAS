...
deepspeed llava/train/berkeley_ur5.py \
    ...
    --version v1 \
    --data_path playground/our_ur5_audio/berkeley_our_ur5_training_audio_cup.json \
    --image_folder /storage/zhaowei/data/berkeley_our_ur5/vla_processed_cup \
    ...
    --action_stat /storage/zhaowei/data/berkeley_our_ur5/training_cup/statistics.yaml \
    ...
    --bf16 True \
    --output_dir /storage/zhaowei/checkpoints/llava-v1.5-7b-ur5-reduce5-4cards-nocotrain-our-normtoken-onberkeley-cup-1002 \
    --num_train_epochs 15 \

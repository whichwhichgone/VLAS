...
deepspeed llava/train/berkeley_ur5.py \
    ...
    --model_name_or_path /storage/zhaowei/checkpoints/llava-v1.5-7b-ur5-reduce5-nocotrain/checkpoint-2058 \
    --version v1 \
    --data_path playground/our_ur5_audio/berkeley_our_ur5_training_audio_bowl.json \
    --image_folder /storage/zhaowei/data/berkeley_our_ur5/vla_processed_bowl \
    ...
    --action_stat /storage/zhaowei/data/berkeley_our_ur5/training_bowl/statistics.yaml \
    ...
    --bf16 True \
    --output_dir /storage/zhaowei/checkpoints/llava-v1.5-7b-ur5-reduce5-4cards-nocotrain-our-normtoken-onberkeley-bowl-1002 \
    --num_train_epochs 15 \

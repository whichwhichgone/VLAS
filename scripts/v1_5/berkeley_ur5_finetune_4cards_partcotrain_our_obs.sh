...
deepspeed llava/train/berkeley_ur5_obs.py \
    ...
    --version v1 \
    --data_path ./playground/our_ur5_audio/ur5_training_audio_cotrain_part.json \
    ...
    --bf16 True \
    --output_dir /storage/zhaowei/checkpoints/llava-v1.5-7b-ur5-reduce5-4cards-partcotrain-our-normtoken-obs \
    --num_train_epochs 10 \

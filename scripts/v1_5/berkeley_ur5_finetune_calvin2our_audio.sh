...
deepspeed llava/train/berkeley_ur5.py \
    ...
    --model_name_or_path ./checkpoints/llava-v1.5-7b-calvin-rel-obs-reduce5-audio \
    --version v1 \
    ...
    --bf16 True \
    --output_dir /storage/zhaowei/checkpoints/llava-v1.5-7b-ur5-reduce5-calvin2our-audio-rbtl \
    --num_train_epochs 10 \
    ...
    --report_to wandb \
    --report_to_wandb_project vlas_real \
    --report_to_wandb_run_name vlas_real_calvin2our_audio

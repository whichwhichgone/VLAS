...
deepspeed llava/train/berkeley_ur5.py \
    ...
    --version v1 \
    --data_path ./playground/berkeley_ur5_audio/ur5_training_audio_cotrain_part.json \
    ...
    --action_stat /storage/zhaowei/data/berkeley_autolab_ur5/training/statistics.yaml \
    ...
    --bf16 True \
    --output_dir /storage/zhaowei/checkpoints/llava-v1.5-7b-ur5-reduce5-cotrain-4cards-part-bklstat \
    --num_train_epochs 1 \

...
deepspeed llava/train/calvin_train_obs_audio.py \
    ...
    --version v1 \
    --data_path ./playground/calvin_data_audio/task_ABCD_D_training_r1_audio.json \
    --image_folder /zhaowei/data/calvin/task_ABCD_D/vla_processed_r1/ \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-calvin-rel-obs-reduce1-audio-v1-abcd2d \
    --num_train_epochs 1 \
    ...
    --report_to_wandb_run_name vlas_ft_stage3_with_audio_abcd2d_r1
